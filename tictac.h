...
class TicTac{
  public:
    ...
    void addRoot(Graph* G, char b[3][3],int x);
    void fillMatrix(Graph* G,char m[3][3],char mat[3][3],int i,int j,int level);
    void insertNode(Graph* G, char b1[3][3], char b2[3][3],int x);
